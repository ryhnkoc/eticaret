            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control kredikarti" id="kart_numarasi" name="cardnumber" style="font-size:20px;" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                       <div class=".col-md-4">
                           ...
                           <div class="form-group">
                               ...
                               <input type="text" class="form-control" name="adsoyad" id="adsoyad" required value="{{auth()->user()->adsoyad}}">
                           </div>
                        ...
                        <div class=".col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="adres" id="adres" required value="{{$kullanici_detay->adres}}">
                            </div>
                    ...
                    <div class="row">
                        <div class=".col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control telefon" name="telefon" id="telefon" required value="{{$kullanici_detay->telefon}}">
                            </div>
                        ...
                        <div class=".col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control telefon" name="ceptelefonu" id="ceptelefonu" required value="{{$kullanici_detay->cepTelefon}}>
                            </div>
