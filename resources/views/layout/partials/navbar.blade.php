    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <form class="navbar-form navbar-left" action="{{route('urun_ara')}}" method="post">
                {{csrf_field()}}<!--Bu alan eklenmediğinde Laravel post işleminin çaılşmasını engelliyor.Her formun içinde bu alan kullanılmalı,güvenlik amacıylada kullanılabilir.-->
