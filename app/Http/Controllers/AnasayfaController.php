...
class AnasayfaController extends Controller
{
    public function index()
    {
        ...
        $urunler_slider=UrunDetay::with('urun')->where('goster_slider',1)->take(3)->get();
        ...
        $urunler_one_cikan=UrunDetay::with('urun')->where('goster_one_cikan',1)->take(3)->get();
        $urunler_cok_satan=UrunDetay::with('urun')->where('goster_cok_satan',1)->take(3)->get();
        $urunler_indirimli=UrunDetay::with('urun')->where('goster_indirimli',1)->take(3)->get();
